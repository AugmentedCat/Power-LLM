...
class GPT2GenerationSpec(GenerationSpec):
    ...
    def initialize(self):
        self.vocab = Vocab(vocab_path=self.vocab_path)  # vocab_path can be None
        self.tokenizer = Tokenizer()  # No vocab parameter needed
...
def add_subparser(subparsers: argparse._SubParsersAction):
    ...
    parser.add_argument('--vocab_path', default=None,
                        help='vocabulary file path (optional - uses GPT-2 pretrained)')
