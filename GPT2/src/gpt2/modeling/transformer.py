...
class TransformerLayer(nn.Module):
    ...
    def __init__(self,
                 ...
                 layer_index: int = 0,
                 use_relu: bool = True,
                 use_post_power_norm: bool = False):
        super().__init__()
        self.attn = AttentionLayer(heads, dims, dropout)
        self.ff = PositionwiseFeedForward(dims, rate, dropout, layer_index, use_relu, use_post_power_norm)
...
class Transformer(nn.Module):
    ...
    def __init__(self,
        ...
        self.transformers = nn.ModuleList([
            TransformerLayer(heads, dims, rate, dropout, layer_index=i, use_relu=use_relu, use_post_power_norm=use_post_power_norm)
